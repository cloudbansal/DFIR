'''
Author: cloudbansal
Code inspired by code I found on github by prolsen.

Takes in exported (csv) Office 365 audit logs and parses the JSON into a more readable format to an excel file
python O365_Parse.py -f AuditLogs.csv -o ParsedAuditLogs

'''

'''
***Some Tags that I Found***

FileModifiedExtended = ['CreationTime', 'Id', 'Operation', 'OrganizationId', 'RecordType', 'UserKey', 'UserType', 'Version', 'Workload', 'ClientIP', 'ObjectId', 'UserId', 'CorrelationId', 'EventSource', 'ItemType', 'ListId', 'ListItemUniqueId', 'Site', 'UserAgent', 'WebId', 'SourceFileExtension', 'SiteUrl', 'SourceFileName', 'SourceRelativeUrl']
FileModified = ['CreationTime', 'Id', 'Operation', 'OrganizationId', 'RecordType', 'UserKey', 'UserType', 'Version', 'Workload', 'ClientIP', 'ObjectId', 'UserId', 'CorrelationId', 'EventSource', 'ItemType', 'ListId', 'ListItemUniqueId', 'Site', 'UserAgent', 'WebId', 'SourceFileExtension', 'SiteUrl', 'SourceFileName', 'SourceRelativeUrl', 'ApplicationDisplayName', 'ApplicationId', 'DoNotDistributeEvent']
Create = ['CreationTime', 'Id', 'Operation', 'OrganizationId', 'RecordType', 'ResultStatus', 'UserKey', 'UserType', 'Version', 'Workload', 'ClientIP', 'UserId', 'ClientIPAddress', 'ClientInfoString', 'ClientProcessName', 'ClientVersion', 'ExternalAccess', 'InternalLogonType', 'LogonType', 'LogonUserSid', 'MailboxGuid', 'MailboxOwnerSid', 'MailboxOwnerUPN', 'OrganizationName', 'OriginatingServer', 'Item', 'SessionId']
MoveToDeletedItems = ['CreationTime', 'Id', 'Operation', 'OrganizationId', 'RecordType', 'ResultStatus', 'UserKey', 'UserType', 'Version', 'Workload', 'ClientIP', 'UserId', 'ClientIPAddress', 'ClientInfoString', 'ClientProcessName', 'ClientVersion', 'ExternalAccess', 'InternalLogonType', 'LogonType', 'LogonUserSid', 'MailboxGuid', 'MailboxOwnerSid', 'MailboxOwnerUPN', 'OrganizationName', 'OriginatingServer', 'SessionId', 'AffectedItems', 'CrossMailboxOperation', 'DestFolder', 'Folder']
MailboxLogin = ['CreationTime', 'Id', 'Operation', 'OrganizationId', 'RecordType', 'ResultStatus', 'UserKey', 'UserType', 'Version', 'Workload', 'ClientIP', 'UserId', 'ClientIPAddress', 'ClientInfoString', 'ExternalAccess', 'InternalLogonType', 'LogonType', 'LogonUserSid', 'MailboxGuid', 'MailboxOwnerSid', 'MailboxOwnerUPN', 'OrganizationName', 'OriginatingServer', 'SessionId']
FileAccessed = ['CreationTime', 'Id', 'Operation', 'OrganizationId', 'RecordType', 'UserKey', 'UserType', 'Version', 'Workload', 'ClientIP', 'ObjectId', 'UserId', 'CorrelationId', 'EventSource', 'ItemType', 'ListId', 'ListItemUniqueId', 'Site', 'UserAgent', 'WebId', 'SourceFileExtension', 'SiteUrl', 'SourceFileName', 'SourceRelativeUrl', 'ApplicationDisplayName', 'ApplicationId']
FileSyncUploadedFull = ['CreationTime', 'Id', 'Operation', 'OrganizationId', 'RecordType', 'UserKey', 'UserType', 'Version', 'Workload', 'ClientIP', 'ObjectId', 'UserId', 'CorrelationId', 'EventSource', 'ItemType', 'ListId', 'ListItemUniqueId', 'Site', 'UserAgent', 'WebId', 'MachineDomainInfo', 'MachineId', 'FileSyncBytesCommitted', 'ImplicitShare', 'SourceFileExtension', 'SiteUrl', 'SourceFileName', 'SourceRelativeUrl']
SearchQueryPerformed = ['CreationTime', 'Id', 'Operation', 'OrganizationId', 'RecordType', 'UserKey', 'UserType', 'Version', 'Workload', 'ClientIP', 'ObjectId', 'UserId', 'ApplicationDisplayName', 'ApplicationId', 'CorrelationId', 'EventSource', 'ItemType', 'UserAgent', 'EventData']
UserLoggedIn = ['CreationTime', 'Id', 'Operation', 'OrganizationId', 'RecordType', 'ResultStatus', 'UserKey', 'UserType', 'Version', 'Workload', 'ClientIP', 'ObjectId', 'UserId', 'AzureActiveDirectoryEventType', 'ExtendedProperties', 'ModifiedProperties', 'Actor', 'ActorContextId', 'ActorIpAddress', 'InterSystemsId', 'IntraSystemId', 'SupportTicketId', 'Target', 'TargetContextId', 'ApplicationId', 'UserAgent.Extended', 'UserAuthenticationMethod.Extended', 'RequestType.Extended', 'ResultStatusDetail.Extended', 'KeepMeSignedIn.Extended', 'LogonError', 'FlowTokenScenario.Extended']
FileAccessedExtended = ['CreationTime', 'Id', 'Operation', 'OrganizationId', 'RecordType', 'UserKey', 'UserType', 'Version', 'Workload', 'ClientIP', 'ObjectId', 'UserId', 'CorrelationId', 'EventSource', 'ItemType', 'ListId', 'ListItemUniqueId', 'Site', 'UserAgent', 'WebId', 'SourceFileExtension', 'SiteUrl', 'SourceFileName', 'SourceRelativeUrl', 'ApplicationDisplayName', 'ApplicationId']
SharingInheritanceBroken = ['CreationTime', 'Id', 'Operation', 'OrganizationId', 'RecordType', 'UserKey', 'UserType', 'Version', 'Workload', 'ClientIP', 'ObjectId', 'UserId', 'CorrelationId', 'EventSource', 'ItemType', 'ListId', 'Site', 'UserAgent', 'WebId', 'EventData', 'UniqueSharingId', 'SiteUrl', 'SourceRelativeUrl']
FolderCreated = ['CreationTime', 'Id', 'Operation', 'OrganizationId', 'RecordType', 'UserKey', 'UserType', 'Version', 'Workload', 'ClientIP', 'ObjectId', 'UserId', 'CorrelationId', 'EventSource', 'ItemType', 'ListId', 'ListItemUniqueId', 'Site', 'UserAgent', 'WebId', 'SourceFileExtension', 'SiteUrl', 'SourceFileName', 'SourceRelativeUrl']
PageViewed = ['CreationTime', 'Id', 'Operation', 'OrganizationId', 'RecordType', 'UserKey', 'UserType', 'Version', 'Workload', 'ClientIP', 'ObjectId', 'UserId', 'CorrelationId', 'CustomUniqueId', 'EventSource', 'ItemType', 'ListItemUniqueId', 'Site', 'UserAgent', 'WebId']
HardDelete = ['CreationTime', 'Id', 'Operation', 'OrganizationId', 'RecordType', 'ResultStatus', 'UserKey', 'UserType', 'Version', 'Workload', 'ClientIP', 'UserId', 'ClientIPAddress', 'ClientInfoString', 'ClientProcessName', 'ClientVersion', 'ExternalAccess', 'InternalLogonType', 'LogonType', 'LogonUserSid', 'MailboxGuid', 'MailboxOwnerSid', 'MailboxOwnerUPN', 'OrganizationName', 'OriginatingServer', 'SessionId', 'AffectedItems', 'CrossMailboxOperation', 'Folder']
FilePreviewed = ['CreationTime', 'Id', 'Operation', 'OrganizationId', 'RecordType', 'UserKey', 'UserType', 'Version', 'Workload', 'ClientIP', 'ObjectId', 'UserId', 'CorrelationId', 'EventSource', 'ItemType', 'ListId', 'ListItemUniqueId', 'Site', 'UserAgent', 'WebId', 'SourceFileExtension', 'SiteUrl', 'SourceFileName', 'SourceRelativeUrl']
SoftDelete = ['CreationTime', 'Id', 'Operation', 'OrganizationId', 'RecordType', 'ResultStatus', 'UserKey', 'UserType', 'Version', 'Workload', 'ClientIP', 'UserId', 'ClientIPAddress', 'ClientInfoString', 'ClientProcessName', 'ClientVersion', 'ExternalAccess', 'InternalLogonType', 'LogonType', 'LogonUserSid', 'MailboxGuid', 'MailboxOwnerSid', 'MailboxOwnerUPN', 'OrganizationName', 'OriginatingServer', 'SessionId', 'AffectedItems', 'CrossMailboxOperation', 'Folder']
FileDownloaded = ['CreationTime', 'Id', 'Operation', 'OrganizationId', 'RecordType', 'UserKey', 'UserType', 'Version', 'Workload', 'ClientIP', 'ObjectId', 'UserId', 'CorrelationId', 'EventSource', 'ItemType', 'ListId', 'ListItemUniqueId', 'Site', 'UserAgent', 'WebId', 'SourceFileExtension', 'SiteUrl', 'SourceFileName', 'SourceRelativeUrl', 'ApplicationDisplayName', 'ApplicationId']
FileSyncDownloadedFull = ['CreationTime', 'Id', 'Operation', 'OrganizationId', 'RecordType', 'UserKey', 'UserType', 'Version', 'Workload', 'ClientIP', 'ObjectId', 'UserId', 'CorrelationId', 'EventSource', 'ItemType', 'ListId', 'ListItemUniqueId', 'Site', 'UserAgent', 'WebId', 'MachineDomainInfo', 'MachineId', 'FileSyncBytesCommitted', 'SourceFileExtension', 'SiteUrl', 'SourceFileName', 'SourceRelativeUrl']
Update = ['CreationTime', 'Id', 'Operation', 'OrganizationId', 'RecordType', 'ResultStatus', 'UserKey', 'UserType', 'Version', 'Workload', 'ClientIP', 'UserId', 'ClientIPAddress', 'ClientInfoString', 'ClientProcessName', 'ClientVersion', 'ExternalAccess', 'InternalLogonType', 'LogonType', 'LogonUserSid', 'MailboxGuid', 'MailboxOwnerSid', 'MailboxOwnerUPN', 'OrganizationName', 'OriginatingServer', 'SessionId', 'Item', 'ModifiedProperties']
FolderModified = ['CreationTime', 'Id', 'Operation', 'OrganizationId', 'RecordType', 'UserKey', 'UserType', 'Version', 'Workload', 'ClientIP', 'ObjectId', 'UserId', 'CorrelationId', 'EventSource', 'ItemType', 'ListId', 'ListItemUniqueId', 'Site', 'UserAgent', 'WebId', 'SourceFileExtension', 'SiteUrl', 'SourceFileName', 'SourceRelativeUrl']
FileDeleted = ['CreationTime', 'Id', 'Operation', 'OrganizationId', 'RecordType', 'UserKey', 'UserType', 'Version', 'Workload', 'ClientIP', 'ObjectId', 'UserId', 'CorrelationId', 'EventSource', 'ItemType', 'ListId', 'ListItemUniqueId', 'Site', 'UserAgent', 'WebId', 'SourceFileExtension', 'SiteUrl', 'SourceFileName', 'SourceRelativeUrl']
FileUploaded = ['CreationTime', 'Id', 'Operation', 'OrganizationId', 'RecordType', 'UserKey', 'UserType', 'Version', 'Workload', 'ClientIP', 'ObjectId', 'UserId', 'CorrelationId', 'EventSource', 'ItemType', 'ListId', 'ListItemUniqueId', 'Site', 'UserAgent', 'WebId', 'SourceFileExtension', 'SiteUrl', 'SourceFileName', 'SourceRelativeUrl']
UserLoginFailed = ['CreationTime', 'Id', 'Operation', 'OrganizationId', 'RecordType', 'ResultStatus', 'UserKey', 'UserType', 'Version', 'Workload', 'ClientIP', 'ObjectId', 'UserId', 'AzureActiveDirectoryEventType', 'ExtendedProperties', 'ModifiedProperties', 'Actor', 'ActorContextId', 'ActorIpAddress', 'InterSystemsId', 'IntraSystemId', 'SupportTicketId', 'Target', 'TargetContextId', 'ApplicationId', 'LogonError', 'UserAgent.Extended', 'FlowTokenScenario.Extended', 'UserAuthenticationMethod.Extended', 'RequestType.Extended', 'ResultStatusDetail.Extended', 'KeepMeSignedIn.Extended']
HygieneTenantEvents = ['CreationTime', 'Id', 'Operation', 'OrganizationId', 'RecordType', 'ResultStatus', 'UserKey', 'UserType', 'Version', 'Workload', 'UserId', 'Audit', 'Event', 'EventId', 'EventValue', 'Reason']
Update user. = ['CreationTime', 'Id', 'Operation', 'OrganizationId', 'RecordType', 'ResultStatus', 'UserKey', 'UserType', 'Version', 'Workload', 'ClientIP', 'ObjectId', 'UserId', 'AzureActiveDirectoryEventType', 'ExtendedProperties', 'ModifiedProperties', 'Actor', 'ActorContextId', 'ActorIpAddress', 'SupportTicketId', 'Target', 'TargetContextId', 'actorContextId.Extended', 'actorObjectId.Extended', 'actorObjectClass.Extended', 'actorUPN.Extended', 'actorPUID.Extended', 'teamName.Extended', 'targetContextId.Extended', 'targetObjectId.Extended', 'extendedAuditEventCategory.Extended', 'targetUPN.Extended', 'targetPUID.Extended', 'targetIncludedUpdatedProperties.Extended', 'correlationId.Extended', 'version.Extended', 'additionalDetails.Extended', 'resultType.Extended', 'auditEventCategory.Extended', 'nCloud.Extended', 'env_ver.Extended', 'env_name.Extended', 'env_time.Extended', 'env_epoch.Extended', 'env_seqNum.Extended', 'env_popSample.Extended', 'env_iKey.Extended', 'env_flags.Extended', 'env_cv.Extended', 'env_os.Extended', 'env_osVer.Extended', 'env_appId.Extended', 'env_appVer.Extended', 'env_cloud_ver.Extended', 'env_cloud_name.Extended', 'env_cloud_role.Extended', 'env_cloud_roleVer.Extended', 'env_cloud_roleInstance.Extended', 'env_cloud_environment.Extended', 'env_cloud_deploymentUnit.Extended', 'Included Updated Properties.NewValue', 'Included Updated Properties.OldValue', 'TargetId.UserType.NewValue', 'TargetId.UserType.OldValue', 'StrongAuthenticationMethod.NewValue', 'StrongAuthenticationMethod.OldValue', 'StrongAuthenticationUserDetails.NewValue', 'StrongAuthenticationUserDetails.OldValue', 'ProxyAddresses.NewValue', 'ProxyAddresses.OldValue']
ModifyFolderPermissions = ['CreationTime', 'Id', 'Operation', 'OrganizationId', 'RecordType', 'ResultStatus', 'UserKey', 'UserType', 'Version', 'Workload', 'ClientIP', 'UserId', 'ClientIPAddress', 'ClientInfoString', 'ExternalAccess', 'InternalLogonType', 'LogonType', 'LogonUserSid', 'MailboxGuid', 'MailboxOwnerSid', 'MailboxOwnerUPN', 'OrganizationName', 'OriginatingServer', 'SessionId', 'Item']
FileRenamed = ['CreationTime', 'Id', 'Operation', 'OrganizationId', 'RecordType', 'UserKey', 'UserType', 'Version', 'Workload', 'ClientIP', 'ObjectId', 'UserId', 'CorrelationId', 'EventSource', 'ItemType', 'ListId', 'ListItemUniqueId', 'Site', 'UserAgent', 'WebId', 'DestinationFileExtension', 'SourceFileExtension', 'DestinationFileName', 'DestinationRelativeUrl', 'SiteUrl', 'SourceFileName', 'SourceRelativeUrl']
RemoveFolderPermissions = ['CreationTime', 'Id', 'Operation', 'OrganizationId', 'RecordType', 'ResultStatus', 'UserKey', 'UserType', 'Version', 'Workload', 'ClientIP', 'UserId', 'ClientIPAddress', 'ClientInfoString', 'ExternalAccess', 'InternalLogonType', 'LogonType', 'LogonUserSid', 'MailboxGuid', 'MailboxOwnerSid', 'MailboxOwnerUPN', 'OrganizationName', 'OriginatingServer', 'SessionId', 'Item']

NormalTags = ['SessionId', 'EventSource', 'SourceRelativeUrl', 'ExternalAccess', 'MailboxOwnerUPN', 'DestinationFileName', 'ListId', 'ItemType', 'DestinationFileExtension', 'ActorIpAddress', 'OriginatingServer', 'ObjectId', 'SiteUrl', 'RecordType', 'UserType', 'MachineId', 'InterSystemsId', 'ClientIP', 'SourceFileName', 'EventId', 'UniqueSharingId', 'InternalLogonType', 'AffectedItems', 'ClientIPAddress', 'TargetContextId', 'ClientProcessName', 'Audit', 'MachineDomainInfo', 'MailboxGuid', 'ClientInfoString', 'OrganizationName', 'SupportTicketId', 'Actor', 'CustomUniqueId', 'EventValue', 'ApplicationDisplayName', 'Folder', 'LogonType', 'CreationTime', 'OrganizationId', 'MailboxOwnerSid', 'ActorContextId', 'Site', 'CorrelationId', 'EventData', 'ListItemUniqueId', 'LogonError', 'DestFolder', 'Reason', 'Operation', 'DestinationRelativeUrl', 'Version', 'Id', 'ImplicitShare', 'LogonUserSid', 'DoNotDistributeEvent', 'UserId', 'IntraSystemId', 'Event', 'UserKey', 'Workload', 'CrossMailboxOperation', 'UserAgent', 'FileSyncBytesCommitted', 'Target', 'SourceFileExtension', 'ClientVersion', 'Item', 'WebId', 'AzureActiveDirectoryEventType', 'ResultStatus', 'ApplicationId']
ExtendedTags = ['actorContextId.Extended', 'teamName.Extended', 'env_epoch.Extended', 'nCloud.Extended', 'env_appId.Extended', 'env_cloud_deploymentUnit.Extended', 'env_cloud_ver.Extended', 'actorUPN.Extended', 'UserAgent.Extended', 'env_ver.Extended', 'env_appVer.Extended', 'env_os.Extended', 'targetPUID.Extended', 'extendedAuditEventCategory.Extended', 'env_iKey.Extended', 'targetContextId.Extended', 'env_cloud_environment.Extended', 'auditEventCategory.Extended', 'env_cloud_roleVer.Extended', 'additionalDetails.Extended', 'UserAuthenticationMethod.Extended', 'targetUPN.Extended', 'env_osVer.Extended', 'env_popSample.Extended', 'env_cloud_roleInstance.Extended', 'env_time.Extended', 'version.Extended', 'env_name.Extended', 'correlationId.Extended', 'targetIncludedUpdatedProperties.Extended', 'env_seqNum.Extended', 'ResultStatusDetail.Extended', 'FlowTokenScenario.Extended', 'actorObjectClass.Extended', 'targetObjectId.Extended', 'env_cv.Extended', 'RequestType.Extended', 'env_cloud_role.Extended', 'actorObjectId.Extended', 'KeepMeSignedIn.Extended', 'env_cloud_name.Extended', 'env_flags.Extended', 'actorPUID.Extended', 'resultType.Extended']
ModifiedTags = ['StrongAuthenticationUserDetails.OldValue', 'ProxyAddresses.OldValue', 'TargetId.UserType.OldValue', 'Included Updated Properties.OldValue', 'Included Updated Properties.NewValue', 'StrongAuthenticationUserDetails.NewValue', 'ProxyAddresses.NewValue', 'StrongAuthenticationMethod.NewValue', 'StrongAuthenticationMethod.OldValue', 'TargetId.UserType.NewValue']
...
# Tried to map as much as I could.
ApplicationId = {
	...
	'89bee1f7-5e6e-4d8a-9f3d-ecd601259da7': 'Office 365 Shell WCSS-Client',
	'28b567f6-162c-4f54-99a0-6887f387bbcc': 'Microsoft Storefronts',
	'bfc44fc5-2fe3-4d02-98ec-1e5967475f68': 'Office 365',
	'd3590ed6-52b3-4102-aeff-aad2292ab01c': 'Microsoft Office',
	'29d9ed98-a469-4536-ade2-f981bc1d605e': 'Microsoft Authentication Broker',
	'a039b054-9847-48fb-824b-1c5b848953e0': 'Roaming',
...
def AppendTags(AllTags):
	row = {}
	for item in AllTags:
		row[item] = ''
	return row
	
def AppendtoList(item,List):
	if item not in List:
		List.append(item)
	return List	 
		
def SpecialkeyProcess(key,data):
	try:
		if key == "UserType":
			row = UserType[data]
		elif key == "ExternalAccess":
			row = ExternalAccess[data]
		elif key == "RecordType":
			row = RecordType[data]
		elif key == "ApplicationId":
			row = ApplicationId[data]
	except:
		row = str(data).strip()
	return row

def GetAllTags(AuditFile):
	NormalTags = []
	ExtendedTags = []
	ModifiedTags = []
	with open(AuditFile,encoding="utf8") as AuditFile:
		reader = csv.reader(AuditFile, delimiter=',')
		for row in reader:		
			data = json.loads(row[3])
			for key in data:
				if key in ["ExtendedProperties"]:
					for item in data[key]:
						exkey = item["Name"]
						ExtendedTags = AppendtoList(exkey+".Extended",ExtendedTags)
				elif key in ["ModifiedProperties"]:
					mfdata = data[key]
					for item in mfdata:
						if "Name" in item:
							mfkey = item["Name"]
							ModifiedTags = AppendtoList(mfkey+".NewValue",ModifiedTags)
							ModifiedTags = AppendtoList(mfkey+".OldValue",ModifiedTags)
						else:
							continue
				else:
					NormalTags = AppendtoList(key,NormalTags)
	AllTags = NormalTags + ExtendedTags + ModifiedTags
	return AllTags
...
def ProcessFile(infile):
	...
	count = 0
	infile = 'parse.csv'
	AllTags = GetAllTags(infile)
	with open(infile,encoding="utf8") as f:
		reader = csv.reader(f, delimiter=',')
		for row in reader:		
			count = count + 1
			MasterLog[count] = AppendTags(AllTags)
			data = json.loads(row[3])
			for key in data:
				if key in ["ExtendedProperties"]:
					exdata = data[key]
					for item in data[key]:
						exkey = item["Name"]
						exvalue = item["Value"]
						MasterLog[count][exkey+".Extended"] = str(exvalue).strip()
				elif key in ["ModifiedProperties"]:
					mfdata = data[key]
					for item in mfdata:
						if "Name" in item:
							...
							MasterLog[count][mfkey+".NewValue"] = str(NewValue).replace('\n', '').replace('\r', '')
							MasterLog[count][mfkey+".OldValue"] = str(OldValue).replace('\n', '').replace('\r', '')
						else:
							continue
				elif key in ["UserType","ExternalAccess","RecordType","ApplicationId"]:
					MasterLog[count][key] = SpecialkeyProcess(key,data[key])
				else:
					MasterLog[count][key] = str(data[key]).strip()
	return AllTags,MasterLog		

def processOutput(MasterLog,outfile,AllTags):
	wb = Workbook() 
	ws = wb.active
	# Column header labels.
	Header = ['LogID']
	Header = Header + AllTags
	ws.append(Header)
	for Line in MasterLog:
		print("Processing Line ",str(Line))
		row = [Line]
		for Tag in AllTags:
			row.append(MasterLog[Line][Tag])
		ws.append(row)
	wb.save(outfile)

def main():
	parser = argparse.ArgumentParser(description='Parse Office 365 csv exported audit logs.')
	parser.add_argument('-f', '--file', required=True,help='Path to the exported O365 CSV audit log file.')
	parser.add_argument('-o', '--out', required=True,help='Name of the out file you want to save everything to xlsx.')
	...
	if not args.out.endswith('.xlsx'):
		...
		outfile = args.out
	AllTags,MasterLog =  ProcessFile(infile)
	processOutput(MasterLog,outfile,AllTags)
